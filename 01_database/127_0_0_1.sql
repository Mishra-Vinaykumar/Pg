...
(11, 'LJ University', 3, 'Screenshot (3).png', 'AC', 'Boys', 'lj dept btec', 'Yes', 'Active', '2024-01-16'),
(12, 'LJ University', 2, 'Screenshot (28).png', 'Non-AC', 'Girls', 'lj dept sci', 'No', 'Active', '0000-00-00'),
(13, 'LJ University', 2, 'Screenshot 2023-09-24 155854.png', 'AC', 'Both/non', 'lj dept politecnic', 'No', 'Active', '0000-00-00'),
(14, 'LJ University', 2, 'Screenshot 2023-11-17 154902.png', 'AC', 'Girls', 'lj dept physio', 'No', 'Active', '0000-00-00');
...
(1, 'Akvi9925', '$2y$10$9gV/1w4PzRYka96jq7SvCup5hcfTwsfamh.9LjXI5ObwqLMUbP8ga');
...
('root', '[{\"db\":\"demo\",\"table\":\"rooms\"},{\"db\":\"demo\",\"table\":\"students\"},{\"db\":\"demo\",\"table\":\"mess\"},{\"db\":\"pg\",\"table\":\"users\"},{\"db\":\"mydatabase\",\"table\":\"users\"}]');
...
('root', 'demo', 'rooms', '{\"sorted_col\":\"`totalroom` ASC\"}', '2024-01-08 06:56:29');
...
('root', '2024-01-12 06:09:38', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":214}');
