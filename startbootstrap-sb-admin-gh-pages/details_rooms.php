                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="hostel_mess_menu.php">Hostel Mess </a>
                            </nav>
                        </div>
  ...
  <tbody>
    ...
    //  echo $_SERVER["PHP_SELF"];
     ?>
      ...
      <td><a class="btn btn-outline-success" href="add_rooms.php?id=<?php echo $row['id']; ?>" role="button">Update</a></td>  
