                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="details_rooms.php">Adding Rooms</a>
                                <a class="nav-link" href="hostel_mess_menu.php">Hostel Mess Menu</a>
                            </nav>
                        </div>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="backend_add_rooms.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" name="rooms"
